...
const Category: CategoryType[] = [
  {
    name: "Adventure",
    slug: "adventure",
    image: "/assets/images/categories/adventure.webp",
  }
]

const Staring: ActorType[] = [{
  name: "Henry Cavill",
  slug: "henry-cavill",
  image: "/assets/images/cast/01.webp",
}]

const Genere: GenereType[] = [
  {
    name: "Drama",
    slug: "drama",
  }
...
export const heroCarousel: HeroCarouselType[] = [
  {
    id: 1,
    title: "The Witcher",
    image: "/assets/images/movies/ott1.webp",
    rated: "Pg",
    duration: "1h 50m",
    rating: "8.2",
    starring: Staring[0],
