...
// Import JSON
import heroSlides from "../../data/homeHeroSlider.json";
  ...
  return (
    <Fragment>
      ...
      >
                ...
                <div className="row align-items-center iq-ltr-direction h-100">
                  <div className="col-lg-7 col-md-12">
                    ...
                    <div className="d-flex flex-wrap align-items-center r-mb-23 RightAnimate-two">
                      ...
                      {slide.genres.map((genre, gIndex) => (
                        <span
                          key={gIndex}
                          className="badge rounded-0 text-white text-uppercase p-2 mx-3 bg-secondary"
                        >
                          {genre}
                        </span>
                      ))}
                      <span className="font-size-14 fw-500 time">{slide.duration}</span>
                    </div>
                    <p className="line-count-3 RightAnimate-two">{slide.description}</p>
        ...
        <div className="swiper-banner-button-prev swiper-nav home-banner-slider-prev">
          <i></i>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="44" height="44">
            <circle r="20" cy="22" cx="22"></circle>
          </svg>
        </div>
        <div className="swiper-banner-button-next swiper-nav home-banner-slider-next">
          <i></i>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="44" height="44">
            <circle r="20" cy="22" cx="22"></circle>
          </svg>
      ...
      {/* @ts-ignore */}
      <FsLightbox toggler={toggler} sources={video ? [video] : []} />
    </Fragment>
  );
});
